...
export const initKeyringFailure = (error) => ({
...
export const loadAccountsFailure = error => ({
    type: LOAD_ACCOUNTS_FAILURE,
    payload: error,
});

export const setActiveAccount = (account, passphrase) => ({
...
export const activeAccountSet = account => ({
    type: ACTIVE_ACCOUNT_SET,
    payload: account,
});

export const addAccount = (phrase, password, username) => ({
    type: ADD_ACCOUNT,
    payload: {
        phrase,
        password,
...
export const accountBalanceUpdated = data => ({
